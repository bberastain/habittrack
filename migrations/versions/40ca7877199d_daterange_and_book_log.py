"""daterange and book log

Revision ID: 40ca7877199d
Revises: 
Create Date: 2018-07-26 17:53:44.951371
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('habit', sa.String(length=140), nullable=True),
